...
void SetBagItemsPointers(void)
{
    ...
    gBagPockets[POCKET_BERRIES].id = POCKET_MEDICINE;
    ...
    gBagPockets[POCKET_BERRIES].id = POCKET_BATTLE_ITEMS;
    ...
    gBagPockets[POCKET_BERRIES].id = POCKET_TREASURES;

    gBagPockets[Z_CRYSTALS_POCKET].itemSlots = gSaveBlock1Ptr->bagPocket_Z_Crystals;
    gBagPockets[Z_CRYSTALS_POCKET].capacity = BAG_Z_CRYSTAL_COUNT;
    gBagPockets[POCKET_BERRIES].id = POCKET_Z_CRYSTALS;
    ...
    gBagPockets[POCKET_BERRIES].id = POCKET_MEGASTONES;
}
