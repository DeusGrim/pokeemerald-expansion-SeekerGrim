...
struct LoadedSaveData
{
 ...
 /*0X230*/  struct ItemSlot megastones[BAG_MEGASTONE_COUNT];
 /*0x230*/  struct ItemSlot zcrystals[BAG_Z_CRYSTAL_COUNT];
};
...
void LoadPlayerBag(void)
{
    ...
    for (i = 0; i < BAG_Z_CRYSTAL_COUNT; i++)
